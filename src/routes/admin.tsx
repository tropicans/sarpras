...
function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-white font-sans text-sm text-[#09090b]">
      {/* Sidebar */}
      <aside className="w-64 border-r border-[#e4e4e7] bg-[#fafafa] flex flex-col justify-between p-4">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-1 px-2 py-3 border-b border-[#e4e4e7]">
            <h1 className="font-semibold text-base leading-tight">Sarpras Admin</h1>
          ...
          <nav className="flex flex-col gap-1">
            <Link
              ...
              inactiveProps={{ className: "text-[#71717a] hover:bg-[#e4e4e7] hover:text-[#09090b]" }}
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 rounded-md font-medium text-[#e11d48] hover:bg-[#fef2f2] transition-colors w-full text-left outline-none"
        >
          <LogOut size={18} />
          <span>Sign Out</span>
        </button>
