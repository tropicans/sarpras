			...
			<aside className="w-64 border-r border-[#e4e4e7] bg-[#fafafa] flex flex-col justify-between p-4 shrink-0">
				<div className="flex flex-col gap-6">
					<div className="flex flex-col gap-1 px-2 py-3 border-b border-[#e4e4e7]">
						<h1 className="font-bold text-base leading-tight text-[#09090b]">
							SARPRAS PPKASN
						</h1>
						<p className="text-xs text-[#71717a] truncate">{user.email}</p>
						<span className="mt-1 self-start px-2 py-0.5 bg-[#e4e4e7] text-[#09090b] text-[10px] font-bold uppercase rounded tracking-wider">
							{user.role === "admin"
								? "Administrator"
								: user.role === "pimpinan"
									? "Pimpinan"
